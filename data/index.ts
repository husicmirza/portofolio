...
export const gridItems = [
  ...
  {
    id: 4,
    title: "Converting challenges into powerful solutions.",
    description: "",
  ...
  {
    id: 5,
    title: "Dive into my GitHub ",
    description: "To see my latest work",
...
export const projects = [
  {
    id: 1,
    title: "Hilink Travel - Resposnsive landing page",
